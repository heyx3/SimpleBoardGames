			...
			if (tapped)
			{
				...
				if (IsClicking)
				{
					...
					if (CurrentlyClicked != null)
					{
						if (IsDragging)
						{
							CurrentlyClicked.OnDrag(StartClickWorldPos, CurrentClickWorldPos);
						}
				...
				else
				{
					...
					if (coll != null)
					{
						...
						{
							CurrentlyClicked = ir;
							ir.OnStartClick(StartClickWorldPos);
						}
					}
				}
			}
			else
			{
				...
				if (IsClicking)
				{
					...
					if (CurrentlyClicked != null)
					{
						if (IsDragging)
						{
							CurrentlyClicked.OnStopDrag(StartClickWorldPos, CurrentClickWorldPos);
						}
						else
						{
							CurrentlyClicked.OnStopClick(StartClickWorldPos);
						}
